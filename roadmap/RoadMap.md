...
**128.** [Что такое JDBC. Подключение к БД. _Connection_](../lessons/jdbc/128/JDBC_introduction_Connection.md)

**129.** [_Statement_. DDL-операции. Знакомство с _ResultSet_](../lessons/jdbc/129/Statement_DDL_ResultSet.md)

**130.** [_PreparedStatement_. Понятие SQL-инъекции](../lessons/jdbc/130/PreparedStatement_SQL_injection.md)

**131.** [Понятие Batch. Использование в JDBC](../lessons/jdbc/131/Batch.md)

**132.** [JDBC и транзакции](../lessons/jdbc/132/JDBC_Tranastions.md)

## Библиотеки для работы с БД

**133.** [Connection Pool. HikariCP](../lessons/db-libraries/133/Connection_Pool_HikariCP.md)

**134.** [Инструменты миграций. Flyway. Аналоги](../lessons/db-libraries/134/Migration_Tools_Flyway_and_others.md)
...
**144.** [JSON](../lessons/out-of-classification/144/JSON.md)
